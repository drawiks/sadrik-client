package sadrik.modules.impl.render.worldparticles;
...
public class Particle implements IMinecraft {
    ...
    private static final Identifier TEXTURE_CROWN = Identifier.of("sadrik", "textures/world/crown.png");
    private static final Identifier TEXTURE_CUBE_BLAST = Identifier.of("sadrik", "textures/world/cubeblast1.png");
    private static final Identifier TEXTURE_DOLLAR = Identifier.of("sadrik", "textures/world/dollar.png");
    private static final Identifier TEXTURE_HEART = Identifier.of("sadrik", "textures/world/heart.png");
    private static final Identifier TEXTURE_LIGHTNING = Identifier.of("sadrik", "textures/world/lightning.png");
    private static final Identifier TEXTURE_LINE = Identifier.of("sadrik", "textures/world/line.png");
    private static final Identifier TEXTURE_RHOMBUS = Identifier.of("sadrik", "textures/world/rhombus.png");
    private static final Identifier TEXTURE_SNOWFLAKE = Identifier.of("sadrik", "textures/world/snowflake.png");
    private static final Identifier TEXTURE_STAR = Identifier.of("sadrik", "textures/world/star.png");
    private static final Identifier TEXTURE_STAR_ALT = Identifier.of("sadrik", "textures/world/star1.png");
    private static final Identifier TEXTURE_TRIANGLE = Identifier.of("sadrik", "textures/world/triangle.png");
    private static final Identifier TEXTURE_GLOW = Identifier.of("sadrik", "textures/world/dashbloom.png");

    private static final Identifier GLOW_BLOOM = Identifier.of("sadrik", "textures/world/dashbloom.png");
    private static final Identifier GLOW_BLOOM_SAMPLE = Identifier.of("sadrik", "textures/world/dashbloomsample.png");
