...
public class ParticleRenderer {
    ...
    private static final Identifier GLOW_TEXTURE = Identifier.of("sadrik", "textures/world/dashbloom.png");
    private static final Identifier GLOW_TEXTURE_SECONDARY = Identifier.of("sadrik", "textures/world/dashbloomsample.png");
