...
import sadrik.events.impl.JumpEvent;
...
public class JumpCircle extends ModuleStructure implements IMinecraft {
    ...
    final Identifier circleTexture = Identifier.of("sadrik", "images/circle/circle.png");
    final Identifier glowTexture = Identifier.of("sadrik", "images/particle/glow.png");
