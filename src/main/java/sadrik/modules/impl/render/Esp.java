...
import sadrik.modules.impl.combat.AntiBot;
...
import sadrik.util.math.Projection;
import sadrik.util.modules.esp.RwPrefix;
...
public class Esp extends ModuleStructure {
    ...
    Identifier TEXTURE = Identifier.of("sadrik", "textures/features/esp/container.png");
