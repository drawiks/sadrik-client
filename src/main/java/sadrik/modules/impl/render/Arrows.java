...
import sadrik.events.impl.DrawEvent;
...
public class Arrows extends ModuleStructure {
    ...
    private static final Identifier ARROW_TEXTURE = Identifier.of("sadrik", "textures/world/arrow.png");
    ...
    public ColorSetting friendArrowColor = new ColorSetting("Цвет друзей", "Цвет стрелок для друзей")
            .value(0xFF00FF00);
    ...
    public Arrows() {
        ...
        settings(arrowsDistance, arrowColor, friendArrowColor);
    }
    ...
    public void onDraw(DrawEvent event) {
        ...
        for (Arrow arrow : playerList) {
            ...
            int color = applyAlpha(FriendUtils.isFriend(player) ? friendArrowColor.getColor() : arrowColor.getColor(), animValue);
