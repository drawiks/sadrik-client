...
public class SoundManager implements IMinecraft {
    public SoundEvent KOLOKOLNIA_KILL = SoundEvent.of(Identifier.of("sadrik:kolokolnia_kill"));
    public SoundEvent MOAN1 = SoundEvent.of(Identifier.of("sadrik:moan1"));
    public SoundEvent MOAN2 = SoundEvent.of(Identifier.of("sadrik:moan2"));
    public SoundEvent MOAN3 = SoundEvent.of(Identifier.of("sadrik:moan3"));
    public SoundEvent MOAN4 = SoundEvent.of(Identifier.of("sadrik:moan4"));
    public SoundEvent MODULE_DISABLE = SoundEvent.of(Identifier.of("sadrik:module_disable"));
    public SoundEvent MODULE_ENABLE = SoundEvent.of(Identifier.of("sadrik:module_enable"));
    public SoundEvent OFF = SoundEvent.of(Identifier.of("sadrik:off"));
    public SoundEvent ON = SoundEvent.of(Identifier.of("sadrik:on"));
    public SoundEvent CRIME = SoundEvent.of(Identifier.of("sadrik:crime"));
    public SoundEvent METALLIC = SoundEvent.of(Identifier.of("sadrik:metallic"));
    public SoundEvent WELCOME = SoundEvent.of(Identifier.of("sadrik:welcome"));
