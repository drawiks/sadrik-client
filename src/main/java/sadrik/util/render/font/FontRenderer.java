...
public class FontRenderer {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger("sadrik/FontRenderer");
    ...
    public void loadFont(String name, String path) {
        Identifier jsonId = Identifier.of("sadrik", "fonts/" + path + ".json");
        Identifier textureId = Identifier.of("sadrik", "fonts/" + path + ".png");
