...
public class FontPipeline {
    ...
    private static final Identifier PIPELINE_ID = Identifier.of("sadrik", "pipeline/msdf");
    private static final Identifier SHADER_ID = Identifier.of("sadrik", "core/msdf");
