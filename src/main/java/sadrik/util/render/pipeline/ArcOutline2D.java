    ...
    public static void init() {
        ...
        try {
            pipeline = RenderPipeline.builder()
                    .withLocation(Identifier.of("sadrik", "core/arc_outline"))
                    .withVertexShader(Identifier.of("sadrik", "core/arc_outline_vertex"))
                    .withFragmentShader(Identifier.of("sadrik", "core/arc_outline_fragment"))
