...
public class OutlinePipeline {
    ...
    private static final Identifier PIPELINE_ID = Identifier.of("sadrik", "pipeline/outline");
    private static final Identifier VERTEX_SHADER = Identifier.of("sadrik", "core/outline");
    private static final Identifier FRAGMENT_SHADER = Identifier.of("sadrik", "core/outline");
