...
public class MaskDiffPipeline {
    ...
    private static final Identifier PIPELINE_ID = Identifier.of("sadrik", "pipeline/mask_diff");
    private static final Identifier VERTEX_SHADER = Identifier.of("sadrik", "core/mask_diff");
    private static final Identifier FRAGMENT_SHADER = Identifier.of("sadrik", "core/mask_diff");
