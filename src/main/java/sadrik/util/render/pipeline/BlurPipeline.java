...
public class BlurPipeline {
    ...
    private static final Identifier PIPELINE_ID = Identifier.of("sadrik", "pipeline/blur");
    private static final Identifier VERTEX_SHADER = Identifier.of("sadrik", "core/blur");
    private static final Identifier FRAGMENT_SHADER = Identifier.of("sadrik", "core/blur");
