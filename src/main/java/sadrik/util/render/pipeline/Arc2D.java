    ...
    public static void init() {
        ...
        try {
            pipeline = RenderPipeline.builder()
                    .withLocation(Identifier.of("sadrik", "core/arc"))
                    .withVertexShader(Identifier.of("sadrik", "core/arc_vertex"))
                    .withFragmentShader(Identifier.of("sadrik", "core/arc_fragment"))
