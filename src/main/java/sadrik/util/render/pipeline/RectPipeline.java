...
public class RectPipeline {
    ...
    private static final Identifier PIPELINE_ID = Identifier.of("sadrik", "pipeline/rect");
    private static final Identifier VERTEX_SHADER = Identifier.of("sadrik", "core/rect");
    private static final Identifier FRAGMENT_SHADER = Identifier.of("sadrik", "core/rect");
