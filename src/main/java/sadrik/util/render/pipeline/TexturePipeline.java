...
public class TexturePipeline {
    ...
    private static final Identifier PIPELINE_ID = Identifier.of("sadrik", "pipeline/texture");
    private static final Identifier VERTEX_SHADER = Identifier.of("sadrik", "core/texture");
    private static final Identifier FRAGMENT_SHADER = Identifier.of("sadrik", "core/texture");
