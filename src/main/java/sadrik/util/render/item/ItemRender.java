package sadrik.util.render.item;
...
public class ItemRender {
    ...
    private static final Map<String, CachedSprite> SPRITE_CACHE = Collections.synchronizedMap(
            new LinkedHashMap<>(16, 0.75f, true) {
                @Override
                protected boolean removeEldestEntry(Map.Entry<String, CachedSprite> eldest) {
